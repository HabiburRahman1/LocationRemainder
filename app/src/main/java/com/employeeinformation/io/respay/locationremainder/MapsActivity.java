package com.employeeinformation.io.respay.locationremainder;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    LatitudeLongitude latitudeLongitudeInfo;
    ...
    private void geoLocate(){
        ...
        String searchString = remainderAddress.getText().toString();
    ...
    public void onConnected(@Nullable Bundle bundle) {
        latitudeLongitudeInfo = new LatitudeLongitude();
    ...
    public void onLocationChanged(Location location) {
        ...
        latitudeLongitudeInfo.setCurrentLatLng(latLng);
//        Geocoder geocoder = new Geocoder(getApplicationContext(), Locale.getDefault());
//        try {
//            List<Address> addresses = geocoder.getFromLocation(location.getLatitude(),location.getLongitude(), 1);
//            Address obj = addresses.get(0);
//            currentAddress.setText(obj.getAddressLine(0).toString());
//
//        } catch (IOException e) {
